...
def upgrade():
    ...
    sa.Column('modified', sa.DateTime(), nullable=True, comment='Время изменения записи'),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=False, comment='Признак активного пользователя'),
    sa.Column('is_verified', sa.Boolean(), nullable=False, comment='Признак верефицированного пользователя'),
